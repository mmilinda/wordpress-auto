...
class Product_Affiliate_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function product_affiliate_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function product_affiliate_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function product_affiliate_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function product_affiliate_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->product_affiliate_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function product_affiliate_load( $class ) {
